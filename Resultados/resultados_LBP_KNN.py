...
ROOT_DIR = r"C:\ruta\a\tus\imagenes"  # Carpeta raíz donde cada subcarpeta es una etiqueta
MODEL_PATH = r"C:\ruta\al\modelo\mejor_modelo_lbp_KNN.pkl"  # Modelo KNN previamente entrenado
